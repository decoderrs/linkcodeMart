...
<div class="card" style="width: 25rem;">
  <div class="card-body">
	...
	<div class="row">
	  <div class="col-md-12">
	    <label for="validationCustom01" class="form-label mt-3">Enter Customer Id</label>
  ...
  <div class="row my-2 ms-2" style="width : 8rem;">
      <button class="btn btn-sm btn-dark" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" type="submit">Enter</button>
  </div>	
	</form>
  </div>
</div>
