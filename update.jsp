...
<%@ page import="Controller.updateServlet"%>
...
<div class="card" style="width: 25rem;">
  <div class="card-body">
  	<h5 class="card-title mb-3">Update!!!</h5>
	<form action="updateServlet" class="row g-3 needs-validation" novalidate>
	<div class="row">
	  <div class="col-md-12">
  	...
  	<div class="row">
	  <div class="col-md-12">
	    <label for="validationCustom01" class="form-label mt-3">Enter Product Price</label>
	    <input type="text" class="form-control" id="validationCustom01" placeholder="Product Id" name="price" required>
	    <div class="valid-feedback">
	      Looks good!
	    </div>
	  </div>   
  ...
  <div class="row my-2 ms-2" style="width : 8rem;">
      <button href="update.jsp" class="btn btn-sm btn-dark" type="submit">Update</button>
  </div>	
	</form>
  </div>
</div>
</div>
	<%-- <%boolean flag=(Boolean)request.getAttribute("delStatus");
	if(flag){%>
  <div class="alert alert-success d-flex align-items-center" id="delpopup" role="alert">
